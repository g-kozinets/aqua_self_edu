...
public class ContactUsPage extends BaseAppForm {
    ...
    private final ILabel lblEmailAlert =getElementFactory().getLabel(By
            .xpath("//span[@role='alert']//preceding-sibling::input[@id='email']"), "Email validating message");
    ...
    public ContactUsPage enterCompany(String company) {
